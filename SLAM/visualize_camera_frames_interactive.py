...
def main() -> None:
    ...
    parser.add_argument(
        "--tracking-log",
        type=Path,
        default=root / "output" / "20260802_150233_orbslam3_stereo" / "tracking_log.csv",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=root / "output" / "20260802_150233_orbslam3_stereo" / "camera_frames_interactive.html",
    )
